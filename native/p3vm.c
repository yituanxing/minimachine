...
/*
 * Optional dense page-pointer directory for the low 32-bit guest space.
 * It costs about 512 KiB.  Same-runner repeats were mixed (-1.49%, +0.07%),
 * so keep it experimental instead of paying the complexity by default.
 */
